...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.lineEdit_S_account.setStyleSheet(
            "QLineEdit{\n"
            "    bakground-color: rgb(255,255,255,0);\n"
            "    border: none;\n"
            "    border-bottom: 1px solid black;\n"
        ...
        self.pushButton_S_login.setStyleSheet(
            "QpushButton:pressed{\n"
            "    padding-top:5px;\n"
            "    padding-left:5px;\n"
    ...
    def retranslateUi(self, LoginWindow):
        ...
        self.label.setText(_translate("LoginWindow", "大学图书订购系统"))
        ...
        self.lineEdit_S_account.setPlaceholderText(
            _translate("LoginWindow", "学生账号：")
        )
        ...
        self.lineEdit_A_account.setPlaceholderText(
            _translate("LoginWindow", "管理员账号：")
        )
