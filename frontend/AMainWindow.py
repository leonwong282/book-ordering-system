...
class Ui_AMainWindow(object):
    def setupUi(self, AMainWindow):
        ...
        self.tableView_A_M_bookList_college.setObjectName(
            "tableView_A_M_bookList_college"
        )
        ...
        self.lineEdit_A_M_new_password_sure.setObjectName(
            "lineEdit_A_M_new_password_sure"
        )
    ...
    def retranslateUi(self, AMainWindow):
        ...
        self.pushButton_A_book.setText(_translate("AMainWindow", "图书订购情况"))
        self.pushButton_A_backup_recover.setText(
            _translate("AMainWindow", "备份与恢复数据")
        )
        ...
        self.lineEdit_A_M_college.setPlaceholderText(
            _translate("AMainWindow", "学院：请输入学院编号")
        )
        self.pushButton_A_M_college_sure.setText(_translate("AMainWindow", "确认"))
        self.lineEdit_A_M_major.setPlaceholderText(
            _translate("AMainWindow", "专业：请输入专业编号")
        )
        self.pushButton_A_M_major_sure.setText(_translate("AMainWindow", "确认"))
        self.pushButton_A_M_out.setText(_translate("AMainWindow", "导出图书订购"))
        ...
        self.lineEdit_A_M_password.setPlaceholderText(
            _translate("AMainWindow", "原密码：")
        )
        self.lineEdit_A_M_password.setEchoMode(QtWidgets.QLineEdit.Password)
        self.lineEdit_A_M_new_password.setPlaceholderText(
            _translate("AMainWindow", "新密码：")
        )
        self.lineEdit_A_M_new_password.setEchoMode(QtWidgets.QLineEdit.Password)
        self.lineEdit_A_M_new_password_sure.setPlaceholderText(
            _translate("AMainWindow", "确认新密码：")
        )
