...
class AMainWindow(QMainWindow):
    def __init__(self, user_now):
        ...
        self.ui.pushButton_A_college.clicked.connect(
            lambda: self.ui.stackedWidget_A.setCurrentIndex(0)
        )
        self.ui.pushButton_A_major.clicked.connect(
            lambda: self.ui.stackedWidget_A.setCurrentIndex(1)
        )
        self.ui.pushButton_A_book.clicked.connect(
            lambda: self.ui.stackedWidget_A.setCurrentIndex(2)
        )
        self.ui.pushButton_A_backup_recover.clicked.connect(
            lambda: self.ui.stackedWidget_A.setCurrentIndex(3)
        )
        self.ui.pushButton_A_update.clicked.connect(
            lambda: self.ui.stackedWidget_A.setCurrentIndex(4)
        )
    ...
    def setup_order_book_list(self):
        ...
        self.ui.tableView_A_M_book_out.horizontalHeader().setSectionResizeMode(
            QHeaderView.Stretch
        )
    ...
    def order_college(self):
        ...
        self.ui.tableView_A_M_bookList_college.horizontalHeader().setSectionResizeMode(
            QHeaderView.Stretch
        )
